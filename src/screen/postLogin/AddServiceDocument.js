...
const AddServiceDocument = ({navigation, route}) => {
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (profile?.name == '') {
                  ...
                  ToastMessage('Document name required');
                } else {
                  //
                  IsInternetConnected()
                    .then(() => {
                      ...
                      formData.append('appointment_id', route?.params?.id);
                      formData.append('document_name', name);
                      dispatch(serviceDocumentAddRequest(formData));
                    })
                    .catch(() => {
                      ToastMessage('Network connection issue');
                    });
...
export default AddServiceDocument;
