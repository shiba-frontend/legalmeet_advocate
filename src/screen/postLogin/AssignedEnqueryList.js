import {
  ...
  const AssignedEnqueryList = ({navigation} ) => {
        ...
        <View
          ...
          {PostReducer?.enquiryList?.length > 0 ? (
            <Text
              ...
              {PostReducer?.assignedenquiryList?.length} Assigned Enquires
            </Text>
          ) : null}
          <FlatList
            data={PostReducer?.assignedenquiryList}
  ...
  export default AssignedEnqueryList